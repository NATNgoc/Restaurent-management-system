...
import java.util.Date;
public class StaffUpdateViewController implements ActionListener {
	StaffUpdateForm view;
	
	public StaffUpdateViewController(StaffUpdateForm view) {
		this.view = view;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int op=JOptionPane.showOptionDialog(view, "Bạn chắc chắn muốn cập nhật nhân viên này?", "Notice", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, null, null);
		if (op==JOptionPane.NO_OPTION) {
			...
			if (check==null) {
				...
				boolean checkAdd=Staff.updateStaff(tmp);
				if (checkAdd==true) {
					JOptionPane.showMessageDialog(view, "Update successfully!");
					view.dispose();
				} else {
					JOptionPane.showMessageDialog(view, "Update unsuccessfully!");
					view.dispose();
				}
